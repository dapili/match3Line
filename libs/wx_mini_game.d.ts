...
declare const wx: {
     ...
     */
    createRewardedVideoAd(res: { adUnitId: string }): RewardedVideoAd;
    /**
    ...
    createUserInfoButton(object: { type: string, text?: string, image?: string, style: any, withCredentials?: boolean, lang?: string }): UserInfoButton;
    /**
